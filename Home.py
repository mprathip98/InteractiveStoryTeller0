    ...
    with (sl.container(border=True)):
        ...
        with colStop3:
            ...
            if restartButton:
                ...
                sl.session_state.story_stage = "-1"
                sl.session_state.story_text = "You find yourself standing at the edge of an ancient forest, its trees towering over you like silent guardians. The air is thick with the scent of damp earth and unseen magic."
                sl.rerun()
    ...
    with (sl.container(border=True)):
        ...
        with col1:
            ...
            if sl.button("Step through the portal."):
                ...
                sl.session_state.story_text = "You emerge in a hidden section of the maze, filled with shimmering crystals and clues to its secrets."
                sl.rerun()
        ...
        with col2:
            ...
            if sl.button(" Ignore the portal and stay."):
                ...
                sl.session_state.story_text = "The music box transforms into a helpful companion that offers advice on navigating the maze."
                sl.rerun()
